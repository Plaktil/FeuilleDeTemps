...
SELECT empId, fname, lname, job, tel, passwd FROM Employes WHERE (empId = @empId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        empId, fname, lname, job, tel, passwd\r\nFROM            Employes\r\nWH" +
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@loginPwd", global::System.Data.SqlDbType.VarChar, 24, global::System.Data.ParameterDirection.Input, 0, 0, "passwd", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
